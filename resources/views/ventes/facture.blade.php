...
<div class="container">
    ...
    <div>
        <strong>{{ $factures[0]->client->nom }} {{ $factures[0]->client->prenom }}</strong>
    </div>

    <a href="/ventes/imprimerFacture/{{ $factures[0]->client_id }}" class="float-right mb-2">Imprimer Facture</a>
